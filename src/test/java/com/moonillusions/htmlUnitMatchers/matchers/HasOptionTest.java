...
public class HasOptionTest {
    ...
    public void convert_value_to_string()
        ...
        HtmlSelect select = (HtmlSelect) TestUtils
                .createDomNode("<select><option value=toStringCalled>mytext</option></select>");
        assertThat(select, hasOption("mytext", myObject, false, 0));
    }
    ...
    // TODO: Describe mismatch for assertThat(select, hasOption("my text",
    // "myValue", false, 0)); is not informative
